...
This course follows the general principles for GenAI from USask [see here](https://academic-integrity.usask.ca/gen-ai.php). They are summarised below
...
In general, my opinion is that you should exploring these tools, what they can do, and how you can integrate them into your work. We will be using co-pilot later in this course. These tools are great for editing, formatting, generating ideas, and writing very  basic code. Not sure where to start, here is a list of tools [https://www.futurepedia.io/](https://www.futurepedia.io/). It's critical that when you use these tools you are very aware of bias and that you intervene to correct the text. Here are my general rules for AI in this course. 

__Unacceptable use__

* It is academic misconduct on this course if the entire student assignment is generated by generative artificial intelligence (GenAI) technology or tools.

__Acceptable use__

* You can use GenAI technology or tools to edit content that they have initially drafted with the use to GenAI, including making changes that improve the clarity of writing and change wording or structure.
* You can use GenAI technology or tools to format, including generating a template or structure that match specifications.
* You can use GenAI technology or tools to get ideas, including suggesting topics, options, ways of doing things.

__Requirements__

* If you use GenAI you must include a 100 word reflective essay about the experience as part of your self-evaluation. You can see the guide on citing GenAI from the library [here](https://libguides.usask.ca/gen_ai/citing). 
...
[Linear Regression – Focus on effect modification](https://github.com/walkabilly/chep801_usask/blob/main/Assignments/Linear%20Regression/Linear-Regression-Assignment.md) | 15%
